...
contract BRF {
	...
	*/
	function createBallot(bytes32[] proposalNames, uint duration) {
	...
	*/
	function vote(uint ballotID, uint proposalID) {
	...
	*/
	function getWinner(uint ballotID) returns (bytes32 winnerName_){
